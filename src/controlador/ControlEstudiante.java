...
public class ControlEstudiante implements ActionListener, MouseListener, ItemListener {
    ...
    public ControlEstudiante(PanelEstudiante panelEstudiante, PanelBotones panelBtn, RegistroEstudiante registroEstudiante, GUIEstudiante guiEstudiante, GUIInforme informe) {
...
//        }
            ...
            informe.setValores(registroEstudiante.getMatrizEstuidiante(), Estudiante.getEtiquetas());
            informe.show();
